...
const CentreCard = ({ centre }) => {
  ...
  const serviceList = useFireStore(centreDetails.services, centre?.id);
  ...
  return (
    ...
    >
      <View>
        <Image source={{ uri: centre?.img }} style={styles.image} />
      </View>
        ...
        <View>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text>{serviceList ? serviceList.length : '0'} services</Text>
            </View>
          </View>
        </View>
      </View>
