    ...
    <ScrollView>
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity>
              <Image
                ...
                source={require('../../assets/Rating_and_Review/ic-info-fill.png')}
              />
            </TouchableOpacity>
          </View>
          <Text style={styles.content}>
            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>$50</Text> / per
            month
          </Text>
        </View>
        <Switch
      ...
      <View style={styles.marketingContainer}>
        <View style={styles.marketingItem}>
          ...
          <Text style={styles.content}>
            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>$30</Text> / per
            month
          </Text>
        </View>
        <Switch
