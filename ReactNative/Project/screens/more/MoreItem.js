        ...
        <View style={styles.mainScreenItem}>
          <View style={styles.mainItem}>
            <View style={styles.line1}>
              ...
              <Image
                style={styles.iconLine1}
                source={require("../../assets/icon_moreItem.png")}
              />
            </View>
          ...
          <View style={styles.bottomItem}>
            <View style={styles.bottomLine1}>
              <Text style={styles.bottomTitle1}>About us</Text>
              <Image
            ...
            <View style={styles.bottomLine6}>
              ...
              <Image
                style={styles.bottomIcon6}
                source={require("../../assets/icon_moreItem.png")}
              />
            </View>
            <View style={styles.bottomLine7}>
              <Text style={styles.bottomTitle7}>FAQ</Text>
              <Image
                style={styles.bottomIcon7}
                source={require("../../assets/icon_moreItem.png")}
              />
            </View>
            <View style={styles.bottomLine8}>
              <Text style={styles.bottomTitle8}>Term & Conditions</Text>
              <Image
                style={styles.bottomIcon8}
                source={require("../../assets/icon_moreItem.png")}
              />
            </View>
            <View style={styles.bottomLine9}>
              <Text style={styles.bottomTitle9}>Privacy Policy</Text>
              <Image
                style={styles.bottomIcon9}
                source={require("../../assets/icon_moreItem.png")}
              />
            </View>
            <View style={styles.bottomLine10}>
              <Text style={styles.bottomTitle10}>Feedback & Support</Text>
              <Image
                style={styles.bottomIcon10}
                source={require("../../assets/icon_moreItem.png")}
              />
            </View>
          </View>
